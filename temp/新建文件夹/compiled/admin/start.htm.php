...
<table cellspacing='1' cellpadding='3'>
  <tr>
    <th colspan="4" align="center" class="group-title"><?php echo $this->_var['lang']['system_info']; ?></th>
  </tr>

  <tr>
    <td align="center"><?php echo $this->_var['lang']['php_version']; ?></td>
    <td align="center" id="php_ver"><?php echo $this->_var['sys_info']['php_ver']; ?></td>
    <td align="center"><?php echo $this->_var['lang']['mysql_version']; ?></td>
    <td align="center" id="mysql_ver"><?php echo $this->_var['sys_info']['mysql_ver']; ?></td>
  </tr>
  <tr>
    <td align="center">最新版本:</td>
    <td align="center" id="pro_ver">4_2</td>
    <td align="center">当前版本:</td>
    <td align="center" id="ver">4_2</td>
  </tr>
  <tr>
    <td align="center"><a href="../mobile/" target="new"><font color="#FF0000">手机前台</font></a></td>
    <td align="center" id="charset"><a href="../mobile/admin/" target="new"><font color="#FF0000">手机后台</a></td>
    <td align="center"><a href="../supplier/" target="new"><font color="red
    ">供应商</a></td>
    <td align="center"></td>
  </tr>
</table>
