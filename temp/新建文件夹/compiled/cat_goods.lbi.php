	...
	<div class="floor02 clearfix">
		<div id="f0" class="home-standard-layout tm-chaoshi-floorlayout <?php if ($this->_var['goods_cat']['id'] == 1): ?>style-one<?php elseif ($this->_var['goods_cat']['id'] == 2): ?> style-two<?php elseif ($this->_var['goods_cat']['id'] == 3): ?>style-three<?php elseif ($this->_var['goods_cat']['id'] == 4): ?>style-four<?php elseif ($this->_var['goods_cat']['id'] == 5): ?>style-five<?php elseif ($this->_var['goods_cat']['id'] == 6): ?>style-six<?php elseif ($this->_var['goods_cat']['id'] == 7): ?>style-seven<?php elseif ($this->_var['goods_cat']['id'] == 8): ?>style-eight<?php endif; ?>">
			<?php
	 		...
	 		?>
			<?php $_from = $this->_var['index_image3']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_70971400_1460516736');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_70971400_1460516736']):
        $this->_foreach['index_image']['iteration']++;
?>
			<a href="<?php echo $this->_var['ad_0_70971400_1460516736']['url']; ?>" class="j_ItemInfo_tong">
				<img data-original="<?php echo $this->_var['ad_0_70971400_1460516736']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading1.gif" alt="" height="100" width="1210">
			</a>
				...
				<div class="header left_floor">
					...
					<div class="recommend">
						<div class="words">
	    					...
	    					?>
							<?php $_from = $this->_var['child_cat']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_71071400_1460516736');$this->_foreach['name1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name1']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_71071400_1460516736']):
        $this->_foreach['name1']['iteration']++;
?>
							<?php $_from = $this->_var['cat_0_71071400_1460516736']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_child');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
?>
						...
						<?php $_from = $this->_var['index_image']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_71071400_1460516736');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_71071400_1460516736']):
        $this->_foreach['index_image']['iteration']++;
?>
						<a href="<?php echo $this->_var['ad_0_71071400_1460516736']['url']; ?>" target="_blank" class="banner">
							<img data-original="<?php echo $this->_var['ad_0_71071400_1460516736']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" height="297" width="240">
						</a>
						<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
						<?php endif; ?>
					</div>
...
?>
		...
		?>
								<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_71071400_1460516736');$this->_foreach['cat_item_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['cat_item_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_71071400_1460516736']):
        $this->_foreach['cat_item_goods']['iteration']++;
?>
								<div class="j_ItemInfo" id="li_<?php echo $this->_var['goods_0_71071400_1460516736']['id']; ?>" <?php if ($this->_foreach['cat_item_goods']['iteration'] % 4 == 0): ?>style="border-right: none"<?php endif; ?>>
									<div class="wrap">
										<a target="_blank" href="<?php echo $this->_var['goods_0_71071400_1460516736']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>">
											<img data-original="<?php echo $this->_var['goods_0_71071400_1460516736']['thumb']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" alt="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>" height="160" width="160" class="pic_img_<?php echo $this->_var['goods_0_71071400_1460516736']['id']; ?>">
										</a>
										<p class="title">
											<a target="_blank" href="<?php echo $this->_var['goods_0_71071400_1460516736']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>"><?php echo $this->_var['goods_0_71071400_1460516736']['short_style_name']; ?></a>
										</p>
										<p class="o-price"><?php echo $this->_var['goods_0_71071400_1460516736']['market_price']; ?></p>
										<p class="price">
											<span class="j_CurPrice">
												<?php if ($this->_var['goods_0_71071400_1460516736']['promote_price'] != ""): ?>
												<?php echo $this->_var['goods_0_71071400_1460516736']['promote_price']; ?>
												<?php else: ?>
												<?php echo $this->_var['goods_0_71071400_1460516736']['shop_price']; ?>
												<?php endif; ?>
											</span>
										</p>
										<a class="j_AddCart" onclick="addToCart(<?php echo $this->_var['goods_0_71071400_1460516736']['id']; ?>)" title="加入购物车"></a>
...
?>
							...
							<div class="tabs-panel tabs-hide">
								<ul>
									...
									?>
									<?php $_from = $this->_var['new_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_71071400_1460516736');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
...
?>
									<div class="j_ItemInfo" <?php if ($this->_foreach['goods']['iteration'] % 4 == 0): ?>style="border-right: none"<?php endif; ?>>
										<div class="wrap">
											<a target="_blank" href="<?php echo $this->_var['goods_0_71071400_1460516736']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>">
												<img src="<?php echo $this->_var['goods_0_71071400_1460516736']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>" height="160" width="160">
											</a>
											<p class="title">
												<a target="_blank" href="<?php echo $this->_var['goods_0_71071400_1460516736']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71071400_1460516736']['name']); ?>"><?php echo $this->_var['goods_0_71071400_1460516736']['short_style_name']; ?></a>
											</p>
				...
				<div class="promo">
					<?php
	 				...
	 				?>
					<?php $_from = $this->_var['index_image1']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_71071400_1460516736');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_71071400_1460516736']):
        $this->_foreach['index_image']['iteration']++;
?>
					<a href="<?php echo $this->_var['ad_0_71071400_1460516736']['url']; ?>" class="j_ItemInfo">
						<img data-original="<?php echo $this->_var['ad_0_71071400_1460516736']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading2.gif" alt="" height="278" width="150">
					</a>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
					<?php
		 			$GLOBALS['smarty']->assign('index_image2',get_advlist('首页-分类ID'.$GLOBALS['smarty']->_var['goods_cat']['id'].'右侧广告2', 1));
	 				?>
					<?php $_from = $this->_var['index_image2']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'ad_0_71071400_1460516736');$this->_foreach['index_image'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad_0_71071400_1460516736']):
        $this->_foreach['index_image']['iteration']++;
?>
					<a href="<?php echo $this->_var['ad_0_71071400_1460516736']['url']; ?>" class="j_ItemInfo">
						<img data-original="<?php echo $this->_var['ad_0_71071400_1460516736']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading2.gif" alt="" height="279" width="150">
					</a>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
				</div>
