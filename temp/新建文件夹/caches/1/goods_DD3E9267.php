...
<title>苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机_iPhone_热卖手机_手机数码_小京东商城  </title>
...
<div id="tell_me_form" style="display:none;">
  ...
  <div class="tell_me_con">
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td class="td_l">&nbsp;</td>
        <td align="left" class="td_r"><input type="button" value="提交" onclick="tell_me1(100)" class="tell_btn"/>
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=100#os_pinglun">1人评价</a></span></p>
                </li>
                <li>
  ...
  if($(a).length > 0){ 
		...
		b.css({"display":"none"});
                            ...
                            <li class="padd padd-promotion clearfix">  
                                ...
                                <div class="dd"> <a class="activity-68 activity_4" href="auction.php" title="拍卖活动" style="font-weight:100; color:#fff; text-decoration:none;">拍卖活动</a> <a href="auction.php" title="苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机" class="activity_con">苹果（Apple）iPhone 6 (A1586) 16GB...</a> </div>
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> 
                                                                             （库存<font id="shows_number">1993 </font>）
                                      </div>
                </div>
              </li>
                          </ul>
  ...
  <script>
      ...
      function clickRight() {
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="100" data-type="1" onclick="Compare.add(100,'苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机','1', 'images/201507/thumb_img/100_thumb_G_1437523484060.jpg', '4888.0 ')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
...
$(function(){
  ...
  <div class="mc">
    <ul>
            <li style="border-top:none;" >
        <div class="p-img">
        	<a href="goods.php?id=155">
            	<img width="100" height="100" alt="三星 Galaxy S6 edge（G9250）32G版 铂光金 移动联通电信4G手机"  src="images/201507/thumb_img/155_thumb_G_1437530585448.jpg"/>
            </a>
        </div>
        <div class="rate"> 
        	<a href="goods.php?id=155" target="_blank" title="三星 Galaxy S6 edge（G9250）32G版 铂光金 移动联通电信4G手机">三星 Galaxy S6 edge（G9250）32G版 铂光金 移动联通电信4G手机</a> 
        </div>
        <div class="p-price"><strong> 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            ...
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=100#os_pinglun" >商品评价(1)</a></li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(100,0,1)" class="cur">全部评价<span>(1)</span></li>
    	...
    	<li id="mct_4" onClick="ShowMyComments(100,4,1)">用户晒单<span>(1)</span></li>
    </ul>
</div>
<div class="blank"></div>
