...
<title>韩国进口X-5花生夹心巧克力棒盒装（24根）864g_糖果巧克力_食品生鲜_小京东商城  </title>
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">韩国进口X-5花生夹心巧克力棒盒装（24根）864g</p>
    ...
    <tr> 
      ...
      <input type="hidden" value="26" name="goods_id" id="goods_id">
  ...
  <div class="tell_me_con">
  	<table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <td colspan="2" align="left" style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">韩国进口X-5花生夹心巧克力棒盒装（24...</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td class="td_l">&nbsp;</td>
        <td align="left" class="td_r"><input type="button" value="提交" onclick="tell_me1(26)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">食品生鲜</a> <code>&gt;</code> <a href="category.php?id=13">糖果巧克力</a> <code>&gt;</code> 韩国进口X-5花生夹心巧克力棒盒装（24根）864g</div>
</div>
<div class="blank"></div>
  <div class="w">
          ...
          <div class="goods_info">
            <div id="name">
              <h1>韩国进口X-5花生夹心巧克力棒盒装（24根）864g</h1>
                        ...
                        <div class="goods_brief"><span>零食大牌远不止一种味道，购满6件立免1件</span></div>
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(26);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">95.0</font> </div>
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 普通会员：79.0</span> 
                     
                    </br>
                    <span class="rmbPrice"> 铜牌会员：75.0</span> 
                     
                    </br>
                    <span class="rmbPrice"> 金牌会员：71.1</span> 
                     
                    </br>
                    <span class="rmbPrice"> 钻石会员：67.1</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=26#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
                  <p>累计销量<span>0</span></p>
                </li>
                                <li style="border:none">
                  <p>赠送积分<span><font id="ECS_GOODS_AMOUNT_jf">79</font></span></p>
                                </ul>
            </div>
            <ul id="summary">
              <script type="text/javascript">
...
var myString=new Array();
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> 
                                                                             （库存<font id="shows_number">1999 </font>）
                                      </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(26)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(26)" class="btn-coll ">收藏</a>   
              </div>
     
              <div id="choose-btns" class="buyNub-buy"> 
                 
                <a href="javascript:addToCart(26,0,1)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(26)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(26)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=26" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
      ...
      <div id="preview">
        <div  class="goods_img" id="li_26"> <a href="images/201507/source_img/26_P_1437505984271.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;"> 
           
          <img  src="images/201507/goods_img/26_P_1437505984456.jpg" class="goodsimg pic_img_26" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" /> 
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/26_P_1437505984271.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/26_P_1437505984456.jpg"   title="" >
	    <img src="images/201507/thumb_img/26_thumb_P_1437505984498.jpg" alt="韩国进口X-5花生夹心巧克力棒盒装（24根）864g" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=26'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="26" data-type="0" onclick="Compare.add(26,'韩国进口X-5花生夹心巧克力棒盒装（24根）864g','0', 'images/201507/thumb_img/26_thumb_G_1437505984631.jpg', '79.0 ')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
  ...
  554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";N;s:3:"num";N;}554fcae493e564ee0dc75bdf2ebf94ca 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=26#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=26#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=26#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=26#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(26)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
