  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=113&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架<b class="icon-order-DESCending"></b></a></dd>
          <dd  class=><a href="category.php?id=113&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量<b class="icon-order-DESCending"></b></a></dd>
          <dd  class=><a href="category.php?id=113&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格<b class="icon-order-DESCending"></b></a></dd>
          <dd  class=curr><a href="category.php?id=113&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新<b class="icon-order-ASCending"></b></a></dd>
          <dd class=><a href="category.php?id=113&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气<b class="icon-order-DESCending"></b></a></dd>
	</dl>
