...
?> 
        ...
        <li class="item" <?php if ($this->_foreach['name']['iteration'] % 4 == 1): ?>style="margin-left:0px;"<?php endif; ?> id="li_<?php echo $this->_var['goods']['goods_id']; ?>">
          <div class="goods-content" style="position:relative">
            <div class="goods-pic" ><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"  title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><img data-original="<?php echo $this->_var['goods']['goods_thumb']; ?>" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" class="pic_img_<?php echo $this->_var['goods']['goods_id']; ?>"></a> </div>
		<?php if ($this->_var['goods']['goods_number'] == 0): ?><a href="<?php echo $this->_var['goods']['url']; ?>" class="shop_over1"></a><?php endif; ?>
            <div class="goods-info"> 
              <div class="goods-name"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php if ($this->_var['goods']['is_product_type'] == 2 || $this->_var['goods']['is_product_type'] == 3): ?>状态：<?php if ($this->_var['goods']['position_state'] == 1): ?>在岗<?php elseif ($this->_var['goods']['position_state'] == 2): ?>待岗<?php endif; ?><?php else: ?><?php echo htmlspecialchars($this->_var['goods']['name']); ?><?php endif; ?><em></em></a><?php if ($this->_var['goods']['is_product_type'] == 2 || $this->_var['goods']['is_product_type'] == 3): ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href=""><em></em>等级：<img src="themes/68ecshopcom_360buy/img/star_<?php echo $this->_var['goods']['stars']; ?>.png" style="height:10px;" /></a><?php endif; ?></div>
              <div class="goods-price">
				<em class="sale-price" title="本店价：<?php if ($this->_var['goods']['promote_price'] != ""): ?><?php echo $this->_var['goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['goods']['shop_price']; ?><?php endif; ?>">
					...
					<?php else: ?>
						...
						<?php else: ?>
						<?php echo $this->_var['goods']['member_price']; ?>
						<?php endif; ?>
					<?php endif; ?>
				</em>
				<?php if ($this->_var['goods']['is_product_type'] == 1): ?>
              ...
              <div class="sell-stat">
				<?php if ($this->_var['goods']['is_product_type'] == 2 || $this->_var['goods']['is_product_type'] == 3): ?>
				<div style="line-height:50px;">
				是否住家：<?php if ($this->_var['goods']['service_type'] == 1): ?>住家<?php else: ?>不住家<?php endif; ?>
				</div>
				<?php else: ?>
				<ul>
				  <li>
					<a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" class="status"><?php echo $this->_var['goods']['count']; ?></a>
                    <p>商品销量</p>
                  </li>
