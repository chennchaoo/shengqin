...
{	 
	...
	$filter = page_and_size($filter);
        $sql = "SELECT sum(goods_amount) as all_money FROM `shengqin`.`ecs_users` AS u inner JOIN `shengqin`.`ecs_order_info` as o ON u.user_id=o.user_id  ".$where.$w." and pay_status = 2";
