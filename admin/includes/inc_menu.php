...
$modules['11_system']['09_area'] = 'shipping_area.php?act=list&shipping=6';
...
$_LANG['21_train'] = '培训招聘';
$modules['21_train']['train_recruit'] = 'train_recruit.php?act=list'; // 报名招聘信息

$_LANG['22_agent'] = '代理商';
$modules['22_agent']['agent'] = 'agent.php?act=list'; // 代理商
$modules['22_agent']['add_agent'] = 'agent.php?act=add'; // 代理商

$_LANG['23_release'] = '发布信息管理';
$modules['23_release']['release'] = 'release.php?act=list';
?>
