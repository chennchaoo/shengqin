...
{
	$sql_hot = "select goods_id, goods_name, goods_thumb, shop_price, market_price, experience, charge_price, member_price, is_product_type from " . $GLOBALS['ecs']->table('goods'). " where ". $rtype ."=1 order by  goods_id desc limit 0,10 ";
	 ...
	 while ($row_hot = $GLOBALS['db']->fetchRow($res_hot))
	 {
		...
		$row_hot['market_price']  =  price_format($row_hot['market_price']);
                $row_hot['experience']    =   $row_hot['experience'];
                $row_hot['charge_price']    =   $row_hot['charge_price'];
                $row_hot['member_price']    =   $row_hot['member_price'];
                $row_hot['is_product_type'] =   $row_hot['is_product_type'];
